    ...
    <div class="floating-social-widget" id="socialWidget">
        <div class="social-menu-items" id="socialMenuItems">
            ...
            <a href="#" class="social-btn" aria-label="WhatsApp">
                <svg viewBox="0 0 24 24"><path d="M16.75 13.96c-.25-.13-1.5-.74-1.73-.82-.23-.08-.41-.13-.58.13-.17.25-.66.82-.81.99-.15.17-.3.19-.55.06-1.5-.71-2.61-1.4-3.64-3.14-.11-.18-.01-.28.11-.4l.28-.32c.1-.13.13-.22.2-.36.06-.15.03-.28-.03-.4-.06-.13-.58-1.4-.79-1.92-.2-.5-.41-.43-.58-.44h-.49c-.2 0-.52.08-.79.37-.27.29-1.02 1-1.02 2.44s1.04 2.83 1.19 3.03c.15.2 2.06 3.15 5 4.42 1.83.8 2.53.86 3.44.73.91-.13 2.19-.9 2.5-1.76.31-.86.31-1.6.22-1.76-.1-.16-.36-.25-.61-.38zM12 22c-1.63 0-3.22-.42-4.63-1.22l-.33-.19-3.45.9 1.05-3.22-.24-.37A9.95 9.95 0 0 1 2 12c0-5.52 4.48-10 10-10s10 4.48 10 10-4.48 10-10 10z"/></svg>
            </a>
