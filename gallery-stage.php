<?php
$pageTitle = "Stage Performances - Dhrupodi Dancers' Association - KUET";
$pageDescription = "Browse our collection of images and videos.";
$pageStylesheets = ['/Dhrupodi/css/pages/gallery.css', '/Dhrupodi/css/pages/gallery-stage.css'];
...
<div class="subpage-container">
    <div class="gallery-header">
        ...
        <h1 class="page-title">Stage Performances</h1>
