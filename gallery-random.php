<?php
$pageTitle = "Random Memories - Dhrupodi Dancers' Association - KUET";
$pageDescription = "Browse our collection of images and videos.";
$pageStylesheets = ['/Dhrupodi/css/pages/gallery.css', '/Dhrupodi/css/pages/gallery-random.css'];
...
<div class="subpage-container">
    <div class="gallery-header">
        ...
        <h1 class="page-title">Random Memories</h1>
