...
<div class="content-area">
    <div style="margin-bottom: 30px;">
        ...
        <h2>Add Image to "<?= htmlspecialchars($category['name']) ?>"</h2>
    </div>
        ...
        <form method="POST" action="" enctype="multipart/form-data">
            <div style="display: grid; grid-template-columns: 1fr; gap: 20px;">
                <div class="form-group">
                    <label class="form-label">Image File * (Max 10MB)</label>
            ...
            <div style="margin-top: 30px;">
                <button type="submit" class="btn btn-primary" style="padding: 12px 30px; font-size: 1.1rem;">Upload Image</button>
            </div>
        </form>
    </div>
</div>
